...
<div class="col-md-6">
    ...
    <form class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" value="<?php echo $member_detail[0]['first_name']." ".$member_detail[0]['last_name']; ?>" id="name" disabled >
            </div>
        </div>
        <div class="form-group">
            <label for="email" class="col-sm-2 control-label">Email</label>
            <div class="col-sm-10">
                <input type="text" value="<?php echo $member_detail[0]['email']; ?>" class="form-control" id="email" disabled >
        </div>
        </div>
        <div class="form-group">
            <label for="status" class="col-sm-2 control-label">Status</label>
            <div class="col-sm-10">
                <input type="text"  value="<?php if($member_detail['0']['active']==1){echo "Active";}elseif($member_detail[0]['active']==0)echo "Inactive" ?>" class="form-control" id="status" disabled>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
               <a href="<?php echo base_url('admin/editmember').'/'.$member_detail['0']['id']; ?>"class="btn btn-default">Edit </a>
                <a  href="<?php echo base_url('admin/deletemember').'/'.$member_detail['0']['id']; ?>"class="btn btn-default">Delete </a>
