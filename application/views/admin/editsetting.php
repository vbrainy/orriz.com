...
<div class="container">
    <div class="col-md-6">
        ...
        <form class="form-horizontal" method="post" action="<?php echo base_url('admin/updatesetting'); ?>">
            <div class="form-group">
                <label for="name" class="col-sm-2 control-label">Name</label>
                <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" value="<?php echo $setting[0]['name']; ?>" id="name"  >
                </div>
            </div>
            <div class="form-group">
                <label for="email" class="col-sm-2 control-label">Email</label>
                <div class="col-sm-10">
                    <input type="text" name="email" value="<?php echo $setting[0]['email']; ?>" class="form-control" id="email"  >
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a href="<?php echo base_url('admin/setting'); ?>" class="btn btn-default">Cancel </a>
                </div>
            </div>
        </form>
